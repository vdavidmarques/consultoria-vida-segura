<?php
//Accordion 3
$accordionT = get_field('accordion-3');
if ($accordionT) {
    //Pacote 1
    $pack1 = $accordionT['package-1'];
    if ($pack1) {
...
?>
    ...
    <div class="accordion-first">
        <?php
        $titleAccordionT = $accordionT['title'];
        if ($titleAccordionT) {
        ?>
            <h3 class="cabecalho"><?php echo $titleAccordionT ?></h3>
        <?php } ?>

        // Opções de Descrições
        <div class="my-20 opcoes-de-descricoes">
            <?php
            $descriptionOptions = $accordionT['descriptions-options'];
            if ($descriptionOptions) :
                if ($accordionT['title-and-text']) :
                    $titleAndDesc = $accordionT['title-and-text'];
                endif;
            else :
                $mainTitleAndIconList =  $accordionT['main-title-and-icon-list'];
            ...
            ?>
                ...
                $listIcon1 =  $accordionT['title-and-icon-list'];
                ...
                $listIcon2 =  $accordionT['title-and-icon-list-2'];
                ...
                $listIcon3 =  $accordionT['title-and-icon-list-3'];
                ...
                $listIcon4 =  $accordionT['title-and-icon-list-4'];
