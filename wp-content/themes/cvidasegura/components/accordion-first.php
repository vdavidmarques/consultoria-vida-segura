<?php
//Accordion 1
$accordionF = get_field('accordion-1');
if ($accordionF) {
    //Pacote 1
    $pack1 = $accordionF['package-1'];
    if ($pack1) {
...
?>
    ...
    <div class="accordion-first">
        <?php
        $titleAccordionF = $accordionF['title'];
        if ($titleAccordionF) {
        ?>
            <h3 class="cabecalho"><?php echo $titleAccordionF ?></h3>
        <?php } ?>

        // Opções de Descrições
        <div class="my-20 opcoes-de-descricoes">
            <?php
            $descriptionOptions = $accordionF['descriptions-options'];
            if ($descriptionOptions) :
                if ($accordionF['title-and-text']) :
                    $titleAndDesc = $accordionF['title-and-text'];
                endif;
            else :
                $mainTitleAndIconList =  $accordionF['main-title-and-icon-list'];
            ...
            ?>
                ...
                $listIcon1 =  $accordionF['title-and-icon-list'];
                ...
                $listIcon2 =  $accordionF['title-and-icon-list-2'];
                ...
                $listIcon3 =  $accordionF['title-and-icon-list-3'];
                ...
                $listIcon4 =  $accordionF['title-and-icon-list-4'];
