...
<div class="wrap">
	...
	<div class="support-data">
		...
		<ul>
		 	<li><?php _e( 'Hire once, get unlimited jobs done', 'wp-slick-slider-and-image-carousel' ); ?></li>				 	
		 	<li><?php _e( 'Quick ticket support, quick solution', 'wp-slick-slider-and-image-carousel' ); ?></li>
		 	<li><?php _e( 'Any sort of WP work with no extra cost', 'wp-slick-slider-and-image-carousel' ); ?></li>
		 	<li><?php _e( 'Dedicated expert working only for you!', 'wp-slick-slider-and-image-carousel' ); ?></li>
		</ul>		
	</div>	
	...
	<table class="wpos-plugin-pricing-table">
	    ...
	    <thead>
	    	<tr>
	    		<th>
	    			<h2><?php _e( 'Hire us for 1 Hr', 'wp-slick-slider-and-image-carousel' ); ?></h2>
	    			<p>$20 USD</p>
	    		</th>
	    		<th>
	    			<h2><?php _e( 'Hire us for 5 Hrs', 'wp-slick-slider-and-image-carousel' ); ?></h2>
	    			<p>$99 USD</p>
	    		</th>
	    		<th>
	    			<h2><?php _e( 'Hire us for 30 Hrs', 'wp-slick-slider-and-image-carousel' ); ?></h2>
	    			<p>$499 USD</p>
	    			<p class="promo"><?php _e( 'Our most valuable package!', 'wp-slick-slider-and-image-carousel' ); ?></p>
	    		</th>
				<th>
	    			<h2><?php _e( 'Hire us for 70 Hrs', 'wp-slick-slider-and-image-carousel' ); ?></h2>
	    			<p>$999 USD</p>
	    		</th>
	    	</tr>
	    </thead>
	    ...
	    <tfoot>
	    	<tr>
	    		<td><a href="https://www.wponlinesupport.com/checkout/?edd_action=add_to_cart&download_id=6044&edd_options[price_id]=6&ref=wposthemeplugin" target="_blank"><?php _e( 'Hire Us', 'wp-slick-slider-and-image-carousel' ); ?></a></td>
	    		<td><a href="https://www.wponlinesupport.com/checkout/?edd_action=add_to_cart&download_id=6044&edd_options[price_id]=3&ref=wposthemeplugin" target="_blank"><?php _e( 'Hire Us', 'wp-slick-slider-and-image-carousel' ); ?></a></td>
	    		<td><a href="https://www.wponlinesupport.com/checkout/?edd_action=add_to_cart&download_id=6044&edd_options[price_id]=4&ref=wposthemeplugin" target="_blank"><?php _e( 'Hire Us', 'wp-slick-slider-and-image-carousel' ); ?></a></td>
				<td><a href="https://www.wponlinesupport.com/checkout/?edd_action=add_to_cart&download_id=6044&edd_options[price_id]=5&ref=wposthemeplugin" target="_blank"><?php _e( 'Hire Us', 'wp-slick-slider-and-image-carousel' ); ?></a></td>
			</tr>
	    </tfoot>	   
	</table>
</div>